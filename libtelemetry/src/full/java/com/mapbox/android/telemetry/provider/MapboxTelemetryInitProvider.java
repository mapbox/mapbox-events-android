...
public class MapboxTelemetryInitProvider extends ContentProvider {
  private static final String TELEMETRY_BASE_PACKAGE_NAME = "com.mapbox.android.telemetry";
  ...
  public boolean onCreate() {
    if (!BuildConfig.DEBUG) {
      // TODO: Register crash reporter only on release builds
      MapboxUncaughtExceptionHanlder.install(getContext(), TELEMETRY_BASE_PACKAGE_NAME);
    }
    return false;
  }
